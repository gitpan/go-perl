# $Id: go-perl.pod,v 1.4 2004/11/30 19:42:42 cmungall Exp $
#
...
L<GO::Model::Term> -- a concept within an ontology

L<GO::Model::Graph> -- collection of relationships between terms
...
<img src="/dev/go-perl/doc/gomodel.png">
...
for full instructions, see L<scripts::map2slim>
...
for full instructions, see L<scripts::go2fmt>
